<div>
            ...
            <div class="flex hidden justify-between items-start">
                ...
                <div>
                    ...
                    <x-layouts.section>
                        ...
                        <div class="flex flex-wrap items-start gap-3">
                            ...
                            <div>
                                <x-input-label for="neet_price" :value="__('Neet Price')" />
                                <x-text-input id="neet_price" class="block mt-1 w-full" type="number"
                                    wire:model.live="neet_price" :value="old('neet_price')" min="0" step="1"
                                    placeholder="00.00" required autocomplete="price" />
                                <x-input-error :messages="$errors->get('neet_price')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="price" :value="__('Seling Price')" />
                                <x-text-input id="price" class="block mt-1 w-full" type="number" wire:model.live="price"
                                    :value="old('price')" min="0" step="1" placeholder="00.00" required
                                    autocomplete="price" />
                                <x-input-error :messages="$errors->get('price')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="stock" :value="__('Stock')" />
                                <x-text-input id="stock" class="block mt-1" type="number" wire:model.lazy="stock"
                        ...
                        <div class="p-3 mt-2 border rounded-md shadow-sm">
                            <div class="flex justify-between items-center pb-2">
                                ...
                                <select wire:model.live="offer_type" class="py-1 px-2 border rounded-md" id="discount">
                            ...
                            <div class="flex space-x-2">
                                <div>
                                    <x-text-input id="discount_save" class="w-48 block mt-1 w-full" type="number"
                                        wire:model.live="discount_save" :value="old('discount_save')" min="0" step="1"
                                        placeholder="100" autocomplete="discount_save" />
                                ...
                                <x-text-input id="discount" class="w-48 block mt-1 w-full border-0 ring-0" type="number"
                                    wire:model.live="discount" disabled :value="old('discount')" min="0" step="1"
                                    placeholder="100" autocomplete="discount" />
                            </div>
                            <div class="mt-1 rounded-md p-3 flex justify-between items-center bg-lime-900 text-white">
                                <div>
                                    Profit
                                    @if ($offer_type)
                                    <span class="ps-2 bg-lime-300 text-white rounded-xl px-2">Discount</span>
                                    @endif
                                </div>
                                <div>
                                    @if ($offer_type)
                                    {{$discount - $neet_price}}
                                    <span class="text-xs px-1 bg-gray-200 rounded-xl"> {{
                                        $price - $neet_price }} </span>
                                    @else
                                    {{ $price - $neet_price }}
                                    @endif
                                </div>
                        ...
                        <div class="py-3">
                            <div class="flex justify-between items-center p-3 border-b">
                                ...
                                <input id="in_stock" wire:model.live='in_stock' type="checkbox"
                            ...
                            <div class="flex justify-between items-center p-3 border-b">
                                ...
                                <input id="display_at_home" wire:model.live='display_at_home' type="checkbox"
                                    class="h-5 w-5 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500"
                            ...
                            <div class="flex justify-between items-center p-3 border-b">
                                ...
                                <input id="courier" type="checkbox"
                                    class="h-5 w-5 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500"
                                    wire:model.live="courier" checked>
                            </div>
                            <div class="flex justify-between items-center p-3 border-b">
                                {{-- hand --}}
                                <div class="ml-2">
                            ...
                            <div class="py-2 bg-gray-100">
                                <div class="flex justify-between items-center p-3 border-b">
                                    ...
                                    <input id="cupon" type="checkbox"
                                        class="h-5 w-5 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500"
                                        wire:model.live="accept_cupon" checked>
                                </div>
                            </div>
                        </div>
                    ...
                    <x-layouts.section>
                        ...
                        <div>
                            <flux:input wire:model="shipping_note" :label="__('Shipping Note')" type="text"
                ...
                <div class="max-w-[260px] ms-3 hidden lg:block static top-[20px] ">
                    ...
                    <x-layouts.section>
                        ...
                        <div>
                            <flux:input wire:model="seo_title" :label="__('SEO Title')" type="text"
                                :placeholder="__('SEO Title')" />
                            <flux:input wire:model="seo_keywords" :label="__('SEO Keyword')" type="text"
                                :placeholder="__('SEO Keyword')" />
                            <flux:input wire:model="seo_description" :label="__('SEO Description')" type="text"
                                :placeholder="__('SEO Description')" />
                            <flux:input wire:model="seo_tags" :label="__('SEO Tags')" type="text"
                                :placeholder="__('SEO Tags')" />
                            <flux:input wire:model="seo_thumbnail" :label="__('SEO Thumbnail')" type="file" />
                        </div>
                    </x-layouts.section>
    ...
    <x-modal name="add-category-modal">
        <x-slot name="header">
            Add Category
        </x-slot>
