                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex space-x-2">
                                ...
                                <x-nav-link href="{{route('system.carousel.slides', ['id' => $item->id])}}">slides
                                </x-nav-link>
                            </div>
                        </td>
                    </tr>
