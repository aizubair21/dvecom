<div x-init="$wire.getRelatedProducts">
    ...
    <x-container>
        ...
        <div class=" lg:flex items-start ">
            <div class="relative md:p-2 mb-2 lg:w-1/2 relative">

                {{-- product image with multiple preview --}}
                <div class="md:p-4 mb-2 flex justify-start items-center">
                    ...
                    <img id="preview"
                        ...
                        alt="" srcset="" class="w-full rounded-lg shadow-xl" style="max-width: 500px; height:auto">
                </div>

                {{-- product gallery --}}
                <div class="border-t md:p-4 flex flex-wrap justify-start items-center space-x-2">
            ...
            {{-- details --}}
            <div class="w-full lg:w-1/2 md:p-5 self-start text-start">
                {{-- product other information --}}
                <x-nav-link type="btn-secondary" href="" wire:navigate
                    class="rounded-full mb-3 flex text-xs text-gray-600">
                    {{$product->category?->name ?? 'Uncategorized'}}
                </x-nav-link>
                <h1 class="text-3xl mt-3 mb-1 font-bold"> {{$product->name}} </h1>
                ...
                <div class="flex space-x-2">
                    ...
                    <x-nav-link type="btn-primary" style="width:100%; max-width:350px; text-align:center"
                        href="{{route('product.order', ['slug' => $product->slug])}}">

                        <div class="flex items-center justify-center w-full text-center uppercase ">

                            <div class="mr-2"> Order Now </div>
                ...
                <div class="md:flex mt-2 justify-between items-center">
                    <x-nav-link href="/">
                        add to card
                    </x-nav-link>
                    <x-nav-link href="/">
        ...
        <div class="my-8 grid grid-cols-2 md:grid-cold-2 lg:grid-cols-4 gap-6">
