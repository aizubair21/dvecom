...
? 'block w-full ps-3 pe-4 py-2 border-l-4 border-lime-400 text-start text-base font-medium text-lime-400
bg-lime-50 focus:outline-none focus:text-lime-600 focus:bg-lime-100 focus:border-lime-600 transition
